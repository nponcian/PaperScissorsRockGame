#ifndef SRC_GAME_SYMBOLS_SCISSORSSYMBOL_HPP
#define SRC_GAME_SYMBOLS_SCISSORSSYMBOL_HPP
...
class ScissorsSymbol : public ISymbol
{
public:
    ScissorsSymbol();
...
#endif // SRC_GAME_SYMBOLS_SCISSORSSYMBOL_HPP
