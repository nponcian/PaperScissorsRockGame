#ifndef SRC_GAME_OUTPUT_FILIPINOOUTPUTTER_HPP
#define SRC_GAME_OUTPUT_FILIPINOOUTPUTTER_HPP
...
class FilipinoOutputter : public IOutputter
{
public:
    FilipinoOutputter();
...
#endif // SRC_GAME_OUTPUT_FILIPINOOUTPUTTER_HPP
