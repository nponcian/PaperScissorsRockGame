#ifndef SRC_GAME_OUTPUT_ENGLISHOUTPUTTER_HPP
#define SRC_GAME_OUTPUT_ENGLISHOUTPUTTER_HPP
...
class EnglishOutputter : public IOutputter
{
public:
    EnglishOutputter();
...
#endif // SRC_GAME_OUTPUT_ENGLISHOUTPUTTER_HPP
